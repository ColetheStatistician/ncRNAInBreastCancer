...
output_filename <- "pc_lambda_results.rds" # CHANGE ME
...
first_two_plus_k_pcs=2; k=12; lambda1=2; lambda2=2; lambda3=2; Y=Y; covariates=covariates
toOpt = c("k", "lambda1", "lambda2", "lambda3")
